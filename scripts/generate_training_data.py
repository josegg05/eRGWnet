...
def generate_train_val_test(args):
    ...
    num_test = round(num_samples * args.test_div)
    num_train = round(num_samples * args.train_div)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_div", type=float, default=0.5, help="Sequence Length.", )
    parser.add_argument("--test_div", type=float, default=0.25, help="Sequence Length.", )
